  ...
  render() {
    return (
      <div>
        ...
        <button className="btn btn-success mt-5 mb-5" onClick={this.increase}><i class="fa fa-plus"></i></button>
        <button className="btn btn-danger mt-5 mb-5" onClick={this.decrease}><i class="fa fa-minus"></i></button>
      </div>
    );
  }
}
